...
public class SwerveAutoBalanceController extends CommandBase {
    private final Timer m_timer = new Timer();

    private final Trajectory m_trajectory;
    private final Supplier<Pose2d> m_pose;
    private final Supplier<Double> m_pitch;
    ...
    public SwerveAutoBalanceController(Trajectory trajectory, Supplier<Pose2d> pose, Supplier<Double> pitch, PidController xController, double xKf,
        ...
        this.m_pitch = (Supplier<Double>) ErrorMessages.requireNonNullParam(pitch, "pitch",
                "SwerveControllerCommand");
