...
/** Add your docs here. */
public class ArmTrajectoryGenerator2 {
    double armLength;
    double maximumVelocity;
    double maximumAcceleration;

    public ArmTrajectoryGenerator2(double maximumVelocity, double maximumAcceleration, double armLength) {
    ...
    public static void main(String[] args) {
        ...
        ArmTrajectoryGenerator2 h = new ArmTrajectoryGenerator2(120, 140, 78);
        int armLength = 78;
