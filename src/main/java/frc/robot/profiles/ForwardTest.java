...
public class ForwardTest extends SequentialCommandGroup {
     ...
     */
    private final String filename = "forward.txt";
    ...
    public ForwardTest() { for (Command command : sequence) addCommands(command); }
}
