...
public class TwoPieceRedCableTest extends SequentialCommandGroup {
     ...
     */
    private final String filename = "two_piece_red_cable.txt";
    ...
    public TwoPieceRedCableTest() { for (Command command : sequence) addCommands(command); }
}
