...
public class TwoConeRed extends SequentialCommandGroup {
     ...
     */
    private final String filename = "two_cone_red.txt";
    ...
    public TwoConeRed() { for (Command command : sequence) addCommands(command); }
}
