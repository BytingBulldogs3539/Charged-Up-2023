...
public class TwoPieceRedCable extends SequentialCommandGroup {
     ...
     */
    private final String filename = "cone_cube_red_cable.txt";
    ...
    public TwoPieceRedCable() { for (Command command : sequence) addCommands(command); }
}
