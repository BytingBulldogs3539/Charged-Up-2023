...
public class PlaceHighConeAndBalance extends SequentialCommandGroup {
  ...
  public PlaceHighConeAndBalance() {
    ...
    addCommands(new ZeroGyroCommand(180), new SetPoseCommand(new Pose2d(0,0, Rotation2d.fromDegrees(180))), new SetArmSide(Sides.front), new SetArmHeight(Arm.high), new SetWristOrientationOverride(Wrist.cone),
