...
public class PlaceHighCubeAndBalance extends SequentialCommandGroup {
  /** Creates a new Place_High_Cone. */
  public PlaceHighCubeAndBalance() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new ZeroGyroCommand(180),new WaitCommand(.25), new SetPoseCommand(new Pose2d(0,0, Rotation2d.fromDegrees(180))), new SetArmSide(Sides.front), new SetArmHeight(Arm.high), new SetWristOrientationOverride(Wrist.cube),
