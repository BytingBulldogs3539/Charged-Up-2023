...
public class VeryHighWeightsShort extends SequentialCommandGroup {
    ...
    private Command[] sequence = {
        ...
        new SetVision(true),
        new SetVisionWeights(2.5, 2.5, 30),
    ...
    public VeryHighWeightsShort() { for (Command command : sequence) addCommands(command); }
}
