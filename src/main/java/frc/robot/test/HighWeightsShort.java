...
public class HighWeightsShort extends SequentialCommandGroup {
    ...
    private Command[] sequence = {
        ...
        new SetVision(true),
        new SetVisionWeights(1.5, 1.5, 20),
    ...
    public HighWeightsShort() { for (Command command : sequence) addCommands(command); }
}
