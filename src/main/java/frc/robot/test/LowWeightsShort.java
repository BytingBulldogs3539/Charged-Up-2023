...
public class LowWeightsShort extends SequentialCommandGroup {
    ...
    private Command[] sequence = {
        ...
        new SetVision(true),
        new SetVisionWeights(0.25, 0.25, 5),
    ...
    public LowWeightsShort() { for (Command command : sequence) addCommands(command); }
}
